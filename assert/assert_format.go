...
//
// Upon failure, the test [T] is marked as failed and continues execution.
func ErrorNotContainsf(t T, err error, contains string, msg string, args ...any) bool {
	if h, ok := t.(H); ok {
		h.Helper()
	}
	return assertions.ErrorNotContains(t, err, contains, forwardArgs(msg, args)...)
}
...
//
// Upon failure, the test [T] is marked as failed and continues execution.
func JSONEqTf[EDoc, ADoc RText](t T, expected EDoc, actual ADoc, msg string, args ...any) bool {
	if h, ok := t.(H); ok {
		h.Helper()
	}
...
//
// Upon failure, the test [T] is marked as failed and continues execution.
func JSONMarshalAsTf[EDoc RText](t T, expected EDoc, object any, msg string, args ...any) bool {
	if h, ok := t.(H); ok {
		h.Helper()
	}
...
//
// Upon failure, the test [T] is marked as failed and continues execution.
func JSONUnmarshalAsTf[Object any, ADoc RText](t T, expected Object, jazon ADoc, msg string, args ...any) bool {
	if h, ok := t.(H); ok {
		h.Helper()
	}
...
//
// Upon failure, the test [T] is marked as failed and continues execution.
func MapEqualTf[K, V comparable](t T, listA map[K]V, listB map[K]V, msg string, args ...any) (ok bool) {
	if h, ok := t.(H); ok {
		h.Helper()
	}
	return assertions.MapEqualT[K, V](t, listA, listB, forwardArgs(msg, args)...)
}
...
//
// Upon failure, the test [T] is marked as failed and continues execution.
func MapNotEqualTf[K, V comparable](t T, listA map[K]V, listB map[K]V, msg string, args ...any) (ok bool) {
	if h, ok := t.(H); ok {
		h.Helper()
	}
	return assertions.MapNotEqualT[K, V](t, listA, listB, forwardArgs(msg, args)...)
}
...
//
// Upon failure, the test [T] is marked as failed and continues execution.
func SliceEqualTf[E comparable](t T, listA []E, listB []E, msg string, args ...any) (ok bool) {
	if h, ok := t.(H); ok {
		h.Helper()
	}
	return assertions.SliceEqualT[E](t, listA, listB, forwardArgs(msg, args)...)
}
...
//
// Upon failure, the test [T] is marked as failed and continues execution.
func SliceNotEqualTf[E comparable](t T, listA []E, listB []E, msg string, args ...any) (ok bool) {
	if h, ok := t.(H); ok {
		h.Helper()
	}
	return assertions.SliceNotEqualT[E](t, listA, listB, forwardArgs(msg, args)...)
}
...
//
// Upon failure, the test [T] is marked as failed and continues execution.
func YAMLEqTf[EDoc, ADoc RText](t T, expected EDoc, actual ADoc, msg string, args ...any) bool {
	if h, ok := t.(H); ok {
		h.Helper()
	}
...
//
// Upon failure, the test [T] is marked as failed and continues execution.
func YAMLMarshalAsTf[EDoc RText](t T, expected EDoc, object any, msg string, args ...any) bool {
	if h, ok := t.(H); ok {
		h.Helper()
	}
...
//
// Upon failure, the test [T] is marked as failed and continues execution.
func YAMLUnmarshalAsTf[Object any, ADoc RText](t T, expected Object, yamlDoc ADoc, msg string, args ...any) bool {
	if h, ok := t.(H); ok {
		h.Helper()
	}
	return assertions.YAMLUnmarshalAsT[Object, ADoc](t, expected, yamlDoc, forwardArgs(msg, args)...)
}

// Zerof is the same as [Zero], but it accepts a format string to format arguments like [fmt.Printf].
//
// Upon failure, the test [T] is marked as failed and continues execution.
