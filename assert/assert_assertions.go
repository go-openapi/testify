...
func Blocked(t T, ch any, msgAndArgs ...any) bool {
	...
	return assertions.Blocked(t, ch, msgAndArgs...)
}
...
func BlockedT[E any, CHAN ~chan E](t T, ch CHAN, msgAndArgs ...any) bool {
	...
	return assertions.BlockedT[E, CHAN](t, ch, msgAndArgs...)
}
...
func ErrorNotContains(t T, err error, contains string, msgAndArgs ...any) bool {
	...
	return assertions.ErrorNotContains(t, err, contains, msgAndArgs...)
}
...
func InEpsilonSymmetric(t T, x any, y any, epsilon float64, msgAndArgs ...any) bool {
	if h, ok := t.(H); ok {
		h.Helper()
	}
	return assertions.InEpsilonSymmetric(t, x, y, epsilon, msgAndArgs...)
}
...
//
// Upon failure, the test [T] is marked as failed and continues execution.
func InEpsilonSymmetricT[Number Measurable](t T, x Number, y Number, epsilon float64, msgAndArgs ...any) bool {
	if h, ok := t.(H); ok {
		h.Helper()
	}
	return assertions.InEpsilonSymmetricT[Number](t, x, y, epsilon, msgAndArgs...)
}
...
func IsDecreasing(t T, collection any, msgAndArgs ...any) bool {
	...
	return assertions.IsDecreasing(t, collection, msgAndArgs...)
}
...
func IsIncreasing(t T, collection any, msgAndArgs ...any) bool {
	...
	return assertions.IsIncreasing(t, collection, msgAndArgs...)
}
...
func IsNonDecreasing(t T, collection any, msgAndArgs ...any) bool {
	...
	return assertions.IsNonDecreasing(t, collection, msgAndArgs...)
}
...
func IsNonIncreasing(t T, collection any, msgAndArgs ...any) bool {
	...
	return assertions.IsNonIncreasing(t, collection, msgAndArgs...)
}
...
func JSONMarshalAsT[EDoc RText](t T, expected EDoc, object any, msgAndArgs ...any) bool {
	...
	return assertions.JSONMarshalAsT[EDoc](t, expected, object, msgAndArgs...)
}
...
func NoGoRoutineLeak(t T, tested func(), msgAndArgs ...any) bool {
	...
	return assertions.NoGoRoutineLeak(t, tested, msgAndArgs...)
}
...
func NotBlocked(t T, ch any, msgAndArgs ...any) bool {
	...
	return assertions.NotBlocked(t, ch, msgAndArgs...)
}
...
func NotBlockedT[E any, CHAN ~chan E](t T, ch CHAN, msgAndArgs ...any) bool {
	...
	return assertions.NotBlockedT[E, CHAN](t, ch, msgAndArgs...)
}
