...
//
// Upon failure, the test [T] is marked as failed and stops execution.
func Condition(t T, comp func() bool, msgAndArgs ...any) {
	if h, ok := t.(H); ok {
		h.Helper()
	}
...
//
// Upon failure, the test [T] is marked as failed and stops execution.
func Consistently[C Conditioner](t T, condition C, timeout time.Duration, tick time.Duration, msgAndArgs ...any) {
	if h, ok := t.(H); ok {
		h.Helper()
	}
	if assertions.Consistently[C](t, condition, timeout, tick, msgAndArgs...) {
		return
	}
...
//
// Upon failure, the test [T] is marked as failed and stops execution.
func ErrorAsType[E error](t T, err error, target *E, msgAndArgs ...any) {
	if h, ok := t.(H); ok {
		h.Helper()
	}
	if assertions.ErrorAsType[E](t, err, target, msgAndArgs...) {
		return
	}
...
//
// Upon failure, the test [T] is marked as failed and stops execution.
func Eventually[C Conditioner](t T, condition C, timeout time.Duration, tick time.Duration, msgAndArgs ...any) {
	if h, ok := t.(H); ok {
		h.Helper()
	}
	if assertions.Eventually[C](t, condition, timeout, tick, msgAndArgs...) {
		return
	}
...
//
// Upon failure, the test [T] is marked as failed and stops execution.
func EventuallyWith[C CollectibleConditioner](t T, condition C, timeout time.Duration, tick time.Duration, msgAndArgs ...any) {
	if h, ok := t.(H); ok {
		h.Helper()
	}
	if assertions.EventuallyWith[C](t, condition, timeout, tick, msgAndArgs...) {
		return
	}
...
//
// Upon failure, the test [T] is marked as failed and stops execution.
func JSONEqT[EDoc, ADoc RText](t T, expected EDoc, actual ADoc, msgAndArgs ...any) {
	if h, ok := t.(H); ok {
		h.Helper()
	}
...
//
// Upon failure, the test [T] is marked as failed and stops execution.
func JSONMarshalAsT[EDoc RText](t T, expected EDoc, object any, msgAndArgs ...any) {
	if h, ok := t.(H); ok {
		h.Helper()
	}
...
//
// Upon failure, the test [T] is marked as failed and stops execution.
func JSONUnmarshalAsT[Object any, ADoc RText](t T, expected Object, jazon ADoc, msgAndArgs ...any) {
	if h, ok := t.(H); ok {
		h.Helper()
	}
...
//
// [comparable-types]: https://go.dev/blog/comparable
func MapEqualT[K, V comparable](t T, listA map[K]V, listB map[K]V, msgAndArgs ...any) {
	if h, ok := t.(H); ok {
		h.Helper()
	}
	if assertions.MapEqualT[K, V](t, listA, listB, msgAndArgs...) {
		return
	}
...
//
// [comparable-types]: https://go.dev/blog/comparable
func MapNotEqualT[K, V comparable](t T, listA map[K]V, listB map[K]V, msgAndArgs ...any) {
	if h, ok := t.(H); ok {
		h.Helper()
	}
	if assertions.MapNotEqualT[K, V](t, listA, listB, msgAndArgs...) {
		return
	}
...
//
// Upon failure, the test [T] is marked as failed and stops execution.
func Never[C NeverConditioner](t T, condition C, timeout time.Duration, tick time.Duration, msgAndArgs ...any) {
	if h, ok := t.(H); ok {
		h.Helper()
	}
	if assertions.Never[C](t, condition, timeout, tick, msgAndArgs...) {
		return
	}
...
//
// Upon failure, the test [T] is marked as failed and stops execution.
func NotErrorAsType[E error](t T, err error, target *E, msgAndArgs ...any) {
	if h, ok := t.(H); ok {
		h.Helper()
	}
	if assertions.NotErrorAsType[E](t, err, target, msgAndArgs...) {
		return
	}
...
//
// [comparable-types]: https://go.dev/blog/comparable
func SliceEqualT[E comparable](t T, listA []E, listB []E, msgAndArgs ...any) {
	if h, ok := t.(H); ok {
		h.Helper()
	}
	if assertions.SliceEqualT[E](t, listA, listB, msgAndArgs...) {
		return
	}
...
//
// [comparable-types]: https://go.dev/blog/comparable
func SliceNotEqualT[E comparable](t T, listA []E, listB []E, msgAndArgs ...any) {
	if h, ok := t.(H); ok {
		h.Helper()
	}
	if assertions.SliceNotEqualT[E](t, listA, listB, msgAndArgs...) {
		return
	}
...
//
// Upon failure, the test [T] is marked as failed and stops execution.
func YAMLEqT[EDoc, ADoc RText](t T, expected EDoc, actual ADoc, msgAndArgs ...any) {
	if h, ok := t.(H); ok {
		h.Helper()
	}
...
//
// Upon failure, the test [T] is marked as failed and stops execution.
func YAMLMarshalAsT[EDoc RText](t T, expected EDoc, object any, msgAndArgs ...any) {
	if h, ok := t.(H); ok {
		h.Helper()
	}
...
//
// Upon failure, the test [T] is marked as failed and stops execution.
func YAMLUnmarshalAsT[Object any, ADoc RText](t T, expected Object, yamlDoc ADoc, msgAndArgs ...any) {
	if h, ok := t.(H); ok {
		h.Helper()
	}
	if assertions.YAMLUnmarshalAsT[Object, ADoc](t, expected, yamlDoc, msgAndArgs...) {
		return
	}
