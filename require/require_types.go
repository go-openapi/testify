...
type (
	...
	WithSynctest = assertions.WithSynctest
	...
	WithSynctestCollect = assertions.WithSynctestCollect
	...
	WithSynctestCollectContext = assertions.WithSynctestCollectContext

	// WithSynctestContext is the [func(context.Context) error] counterpart
	// of [WithSynctest]. See [WithSynctest] for details.
	WithSynctestContext = assertions.WithSynctestContext
)
