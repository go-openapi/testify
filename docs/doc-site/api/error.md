...
This is a wrapper for [errors.As](https://pkg.go.dev/github.com/go-openapi/testify/v2/assert#errors.As)(https://pkg.go.dev/errors#As).
...
This is a wrapper for [errors.Is](https://pkg.go.dev/github.com/go-openapi/testify/v2/assert#errors.Is)(https://pkg.go.dev/errors#Is).
