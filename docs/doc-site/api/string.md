...
The regular expression may be passed as a [regexp.Regexp](https://pkg.go.dev/github.com/go-openapi/testify/v2/assert#regexp.Regexp)(https://pkg.go.dev/regexp#Regexp), a string or a []byte and will be compiled.

The actual argument to be matched may be a string, []byte or anything that prints as a string with [fmt.Sprint](https://pkg.go.dev/github.com/go-openapi/testify/v2/assert#fmt.Sprint)(https://pkg.go.dev/fmt#Sprint).
